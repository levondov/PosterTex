...
\node at (16, 0){\includegraphics[width=75pt]{Pics/PTB-Logo.pdf}};
\end{tikzpicture}
}
...
\node at (1,0.8) {\includegraphics[width=300pt]{Pics/diagramtext.pdf}
};
\node at (8.7,1) {\fbox{\includegraphics[width=90pt]{Pics/verticalbeam.pdf}}
};
\node at (6,-4.8) {\fbox{\includegraphics[width=175pt]{Pics/horizontaltable.pdf}}
};
\node at (6,-2.7) {
