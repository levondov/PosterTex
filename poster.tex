...
\node at (0,3.3) {\fbox{\includegraphics[height=100pt]{IP/analog10sx50_backgroundsubstractedcrop.pdf}}
};
\node at (5.5,2) {\fbox{\includegraphics[height=100pt]{IP/lowalpha_100mA_zerisseneFuellungmitLueckecrop.pdf}}
};
\node at (11,3.3) {\fbox{\includegraphics[height=100pt]{IP/lowalpha_1uAcrop.pdf}}
};
\node at (1,5.5) {
...
\node at (11,-0.5) {\includegraphics[width=2cm]{Pics/qrcode.pdf}};
\node at (11,0.5) {
\begin{varwidth}{3cm}
...
\node at (0,0) {
\begin{varwidth}{3cm}
The new streak camera has a much more improved ability to filter out noise and white light
\end{varwidth}
};
\end{tikzpicture}
}
